...
export default function PhoneInput({
  ...
  return (
    <div className="rankcare-phone-field">
      <label htmlFor={id}>Mobile number</label>
      <div className="rankcare-phone-control">
        <div className="rankcare-phone-country-selector">
          <button
            type="button"
            className="rankcare-phone-country-button"
          ...
          {countryPickerOpen && (
            <div className="rankcare-phone-country-dropdown" role="dialog" aria-label="Choose country">
              <input
                ref={countrySearchRef}
                type="search"
                className="rankcare-phone-country-search"
              ...
              />
              <div className="rankcare-phone-country-list" role="listbox" aria-label="Countries">
                {filteredCountries.map((candidate) => (
                  <button
                    ...
                    className="rankcare-phone-country-option"
                ...
                {!filteredCountries.length && <p className="rankcare-phone-empty">No countries found.</p>}
              </div>
            </div>
          )}
        </div>
        <input
          ...
          className="rankcare-phone-number-input"
          aria-invalid={Boolean(error)}
          aria-describedby={error ? `${id}-error` : undefined}
        />
      </div>
      {error && <p id={`${id}-error`} className="rankcare-phone-error">{error}</p>}
    </div>
  );
}
