...
MARKETING_FAQS = [
    {
        ...
        "a": "Each plan has clearly stated project, keyword, and paid-feature limits. Credit charges are transparent: adding a keyword costs 20 credits, manual refresh is 20 credits/keyword, weekly refresh is 10 credits/keyword, keyword research is 20 credits, competitor spy is 30 credits, and CSV exports are 10 credits. Project creation is free.",
    },
    {
    ...
    },
    {
        ...
        "a": "Plan credits reset at your billing-cycle boundary, and unused plan credits do not roll over. Purchased top-up credits remain separate and survive future plan-credit resets. You can top up 600 credits anytime for a flat ₹100 on the Billing page.",
    },
    {
    ...
    },
    {
        ...
        "a": "AI Overview (AIO) tracking is available on Starter, Pro, and Agency plans. Free-plan users cannot access AIO tracking. You can toggle AI tracking per keyword from the keyword table.",
    },
    {
