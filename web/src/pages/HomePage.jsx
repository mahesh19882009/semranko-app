      ...
      <section style={styles.linkSection}>
        <div style={styles.container}>
          <div style={styles.linkGrid}>
            <Link to="/free-tools" style={styles.linkCard}>
              <h3 style={styles.linkTitle}>Explore Free Tools</h3>
              <p style={styles.linkText}>
                Start with lightweight SEO checks and move into full tracking later.
              </p>
            </Link>

            <Link to="/about" style={styles.linkCard}>
              <h3 style={styles.linkTitle}>Why RankCare</h3>
              <p style={styles.linkText}>
                Learn what the platform is focused on and who it is built for.
              </p>
            </Link>

            <Link to="/contact" style={styles.linkCard}>
              <h3 style={styles.linkTitle}>Talk to Us</h3>
              <p style={styles.linkText}>
                Reach out for product questions, onboarding, or pricing discussions.
              </p>
            </Link>
          </div>
        </div>
